              ...
              children: [
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Shimmer.fromColors(
                        ...
                        child: Text("Sign up",
                        style: TextStyle(fontSize: 50,fontWeight: FontWeight.bold,fontFamily: "Times New Roman"),
                        ),
                      ),
                    ),
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      style: TextStyle(fontWeight: FontWeight.bold,fontSize: 30,color: Colors.white,fontFamily: "Cursive"),
                      ),
                    ],
                  ),
                ),
                ...
                Padding(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.start,
                    children: [
                      Text("Email",style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),),
                    ],
                  ),
                ),
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(child: Text("Create Account",style: TextStyle(color: Colors.white,fontSize: 25,fontWeight: FontWeight.bold),)),
